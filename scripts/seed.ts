    ...
    theoryCards: [
      {
        ...
        formula: "a⃗(x₁;y₁)±b⃗(x₂;y₂) = (x₁±x₂; y₁±y₂);  k·a⃗(x;y) = (kx; ky)",
      ...
      },
      {
        ...
        formula: "a⃗·b⃗ = x₁x₂ + y₁y₂",
        body: "Скалярное произведение — сумма произведений соответствующих координат. Если a⃗·b⃗=0, векторы перпендикулярны.",
      },
      {
  ...
  db.problems.push(
    {
      id: stableId("p"),
      skillId: skVecOps,
      text: "Даны векторы a⃗(17;0) и b⃗(1;−1). Найдите длину вектора a⃗−12b⃗.",
      answerType: "NUMBER",
      correctAnswer: "13",
      keyFormula: "|a⃗−12b⃗| = √(x²+y²)",
      hints: ["Найдите координаты вектора a⃗−12b⃗ покоординатно, затем примените формулу длины."],
      explanation: "a⃗−12b⃗=(17−12;0+12)=(5;12). Длина: √(25+144)=√169=13.",
      difficulty: 1,
      egeTaskNumber: 2,
    },
    {
      id: stableId("p"),
      skillId: skVecOps,
      text: "Даны векторы a⃗(3;3), b⃗(7;8) и c⃗(13;29). Найдите сумму координат вектора a⃗+b⃗−c⃗.",
      answerType: "NUMBER",
      correctAnswer: "-21",
      hints: ["Найдите координаты вектора r⃗=a⃗+b⃗−c⃗ покоординатно, затем сложите обе координаты."],
      explanation: "r⃗=(3+7−13;3+8−29)=(−3;−18). Сумма координат: −3+(−18)=−21.",
      difficulty: 1,
      egeTaskNumber: 2,
    },
    {
      id: stableId("p"),
      skillId: skVecOps,
      text: "Даны векторы a⃗(5;−7) и b⃗(14;1). Найдите скалярное произведение a⃗·b⃗.",
      answerType: "NUMBER",
      correctAnswer: "63",
      keyFormula: "a⃗·b⃗ = x₁x₂+y₁y₂",
      hints: ["Перемножьте соответствующие координаты и сложите результаты."],
      explanation: "a⃗·b⃗=5·14+(−7)·1=70−7=63.",
      difficulty: 1,
      egeTaskNumber: 2,
    },
    {
      id: stableId("p"),
      skillId: skVecOps,
      text: "Даны векторы a⃗(5;3) и b⃗(4;−6). Найдите скалярное произведение a⃗·b⃗.",
      answerType: "NUMBER",
      correctAnswer: "2",
      hints: ["Перемножьте соответствующие координаты и сложите результаты."],
      explanation: "a⃗·b⃗=5·4+3·(−6)=20−18=2.",
      difficulty: 1,
      egeTaskNumber: 2,
      tier: "bank",
    },
    {
      id: stableId("p"),
      skillId: skVecOps,
      text: "Даны векторы a⃗(1;2), b⃗(3;−6) и c⃗(4;−3). Найдите скалярное произведение (a⃗+b⃗)·c⃗.",
      answerType: "NUMBER",
      correctAnswer: "28",
      hints: ["Сначала найдите координаты вектора a⃗+b⃗, затем примените формулу скалярного произведения с c⃗."],
      explanation: "a⃗+b⃗=(1+3;2−6)=(4;−4). (a⃗+b⃗)·c⃗=4·4+(−4)·(−3)=16+12=28.",
      difficulty: 2,
      egeTaskNumber: 2,
      tier: "bank",
    },
    {
      id: stableId("p"),
      skillId: skVecOps,
      text: "Даны векторы a⃗(5/3;5) и b⃗(4;2). Найдите угол между векторами a⃗ и b⃗. Ответ дайте в градусах.",
      answerType: "NUMBER",
      correctAnswer: "45",
      keyFormula: "cos φ = (a⃗·b⃗)/(|a⃗|·|b⃗|)",
      hints: [
        "Найдите скалярное произведение и длины обоих векторов отдельно, затем подставьте в формулу косинуса угла.",
      ],
      explanation: "a⃗·b⃗=(5/3)·4+5·2=50/3. |a⃗|=5√10/3, |b⃗|=2√5. cosφ=(50/3)/((5√10/3)·2√5)=√2/2 ⟹ φ=45°.",
      difficulty: 3,
      egeTaskNumber: 2,
    }
  );
  ...
  db.problems.push(
    {
      id: stableId("p"),
      skillId: skVecOnGrid,
      text: "На координатной плоскости изображены векторы a⃗, b⃗ и c⃗. Найдите длину вектора a⃗+b⃗+c⃗.",
      answerType: "NUMBER",
      correctAnswer: "0",
      diagram: {
        kind: "vectorPlane",
      ...
      hints: [
        "Считайте координаты каждого вектора по клеткам сетки от начала координат: a⃗(1;2), b⃗(4;0), c⃗(−5;−2).",
        "Сложите координаты всех трёх векторов покоординатно.",
      ],
      explanation: "a⃗+b⃗+c⃗=(1+4−5;2+0−2)=(0;0) — нулевой вектор. Его длина равна 0.",
      difficulty: 2,
      egeTaskNumber: 2,
    },
    {
      id: stableId("p"),
      skillId: skVecOnGrid,
      text: "На координатной плоскости изображены векторы a⃗ и b⃗. Найдите длину вектора a⃗−b⃗.",
      answerType: "NUMBER",
      correctAnswer: "6.5",
      diagram: {
        kind: "vectorPlane",
      ...
      hints: [
        "Считайте координаты векторов по клеткам: a⃗(2;3), b⃗(−4;0,5).",
        "Найдите разность покоординатно, затем длину получившегося вектора.",
      ],
      explanation: "a⃗−b⃗=(2−(−4);3−0,5)=(6;2,5). Длина: √(36+6,25)=√42,25=6,5.",
      difficulty: 2,
      egeTaskNumber: 2,
    },
    {
      id: stableId("p"),
      skillId: skVecOnGrid,
      text: "На координатной плоскости изображены векторы a⃗ и b⃗, координаты которых являются целыми числами. Найдите длину вектора a⃗+3b⃗.",
      answerType: "NUMBER",
      correctAnswer: "8",
      diagram: {
        kind: "vectorPlane",
      ...
      hints: ["Считайте координаты векторов по клеткам: a⃗(2;3), b⃗(2;−1).", "Умножьте b⃗ на 3, затем сложите с a⃗ покоординатно."],
      explanation: "a⃗+3b⃗=(2+6;3−3)=(8;0). Длина: √(64+0)=8.",
      difficulty: 2,
      egeTaskNumber: 2,
      tier: "bank",
    },
    {
      id: stableId("p"),
      skillId: skVecOnGrid,
      text: "На координатной плоскости изображены векторы a⃗ и b⃗. Найдите скалярное произведение этих векторов.",
      answerType: "NUMBER",
      correctAnswer: "56",
      diagram: {
        kind: "vectorPlane",
      ...
      explanation: "a⃗=(−4;−9), b⃗=(−5;−4). Скалярное произведение: (−4)·(−5)+(−9)·(−4)=20+36=56.",
      difficulty: 3,
      egeTaskNumber: 2,
      tier: "bank",
    },
    {
      ...
      hints: ["Считайте координаты векторов по клеткам как (конец минус начало): a⃗(4;6), b⃗(6;−2)."],
