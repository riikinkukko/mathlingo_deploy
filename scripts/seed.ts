...
async function main() {
  ...
  const skParallelogramBisector = stableId("sk");
  ...
  const skills: Skill[] = [
    ...
    },
    {
      ...
      theoryCards: [
        ...
        },
        {
          ...
          diagram: { kind: "triangleCevian", variant: "bisector" },
        },
        {
          title: "Высота",
    ...
    {
      id: skParallelogramBisector,
      subtopicId: chParallelogram,
      order: 4,
      title: "Биссектриса угла параллелограмма",
      theoryCards: [
        {
          title: "Биссектриса отсекает равнобедренный треугольник",
          body: "Биссектриса угла параллелограмма, пересекающая противоположную сторону (или её продолжение), всегда отсекает равнобедренный треугольник. Это следует из того, что накрест лежащие углы при параллельных сторонах равны углу, на который делит биссектриса исходный угол — значит, у отсечённого треугольника два равных угла.",
          diagram: { kind: "parallelogram", bisector: { from: "A", toSide: "BC", t: 0.5, label: "M" } },
        },
        {
          title: "Как это использовать",
          body: "Если биссектриса делит сторону, к которой она проведена, на отрезки — воспользуйтесь равнобедренностью отсечённого треугольника (два равных отрезка) вместе с тем, что сумма или разность отрезков стороны параллелограмма равна известной длине.",
        },
      ],
    },
    {
  ...
  db.problems.push(
    {
      id: stableId("p"),
      skillId: skParallelogramBisector,
      text: "Биссектриса угла A параллелограмма ABCD пересекает сторону BC в точке M, причём BM=5, MC=3. Найдите периметр параллелограмма ABCD.",
      answerType: "DETAILED",
      correctAnswer: "26",
      diagram: { kind: "parallelogram", bisector: { from: "A", toSide: "BC", t: 0.625, label: "M" } },
      keyFormula: "AB=BM (биссектриса отсекает равнобедренный треугольник)",
      hints: [
        "AD∥BC, поэтому накрест лежащие углы DAM и AMB равны. Биссектриса делает угол BAM равным углу DAM — значит, угол BAM равен углу AMB.",
        "Из равенства углов BAM и AMB треугольник ABM равнобедренный: AB=BM=5. Тогда BC=BM+MC=8.",
      ],
      explanation:
        "Так как AD∥BC, а AM — секущая, накрест лежащие углы DAM и AMB равны. AM — биссектриса угла A, поэтому угол BAM=угол DAM=угол AMB — треугольник ABM равнобедренный с AB=BM=5. Значит, BC=BM+MC=5+3=8, а AD=BC=8, CD=AB=5. Периметр=2(AB+BC)=2(5+8)=26.",
      difficulty: 3,
      egeTaskNumber: 4,
    },
    {
      id: stableId("p"),
      skillId: skParallelogramBisector,
      text: "Биссектриса угла A параллелограмма ABCD пересекает сторону BC в точке M. Периметр параллелограмма равен 34, сторона AB равна 7. Найдите MC.",
      answerType: "DETAILED",
      correctAnswer: "3",
      diagram: { kind: "parallelogram", bisector: { from: "A", toSide: "BC", t: 0.7, label: "M" } },
      keyFormula: "AB=BM; периметр=2(AB+BC)",
      hints: [
        "Из периметра и известной стороны AB найдите сторону BC: периметр=2(AB+BC).",
        "Биссектриса отсекает равнобедренный треугольник ABM, поэтому BM=AB. Тогда MC=BC−BM.",
      ],
      explanation:
        "Из периметра: 2(AB+BC)=34 ⟹ AB+BC=17 ⟹ BC=17−7=10. По свойству биссектрисы угла параллелограмма треугольник ABM равнобедренный: BM=AB=7. Значит, MC=BC−BM=10−7=3.",
      difficulty: 3,
      egeTaskNumber: 4,
    }
  );
  ...
  const skRevolutionSections = stableId("sk");
  ...
  db.skills.push({
    id: skRevolutionSections,
    subtopicId: chStereoRevolution,
    order: 3,
    title: "Сечения тел вращения",
    theoryCards: [
      {
        title: "Осевое сечение конуса",
        body: "Сечение конуса плоскостью, проходящей через вершину, — равнобедренный треугольник с боковыми сторонами, равными образующей l. Если известен угол при вершине, площадь такого сечения находится как площадь равнобедренного треугольника по двум сторонам и углу между ними: S=(1/2)·l²·sin(угла).",
      },
      {
        title: "Скрещивающиеся прямые в цилиндре",
        body: "Расстояние между двумя скрещивающимися прямыми ищут через векторное произведение направляющих векторов: d=|(A₂A₁)·[u,v]|/|[u,v]|, где u, v — направляющие векторы прямых, A₁, A₂ — по точке на каждой прямой. Удобно ввести координаты с началом в центре одного из оснований.",
      },
    ],
  });
  ...
  db.problems.push(
    {
      id: stableId("p"),
      skillId: skRevolutionSections,
      text: "Радиус основания конуса равен 5, высота равна 3. Через вершину конуса проведена плоскость сечения так, что угол между боковыми сторонами полученного в сечении треугольника — прямой. Найдите площадь этого сечения.",
      answerType: "DETAILED",
      correctAnswer: "17",
      diagram: { kind: "cone", section: { angleA: 55, angleB: 125, labelA: "A", labelB: "B" } },
      keyFormula: "l²=r²+h²;  S=(1/2)·l² (при прямом угле при вершине)",
      hints: [
        "Образующая конуса l=√(r²+h²). Проверьте, что хорда AB=l√2 не превышает диаметр основания — иначе такое сечение невозможно.",
        "Треугольник SAB равнобедренный (SA=SB=l) с прямым углом при S — его площадь равна (1/2)·SA·SB.",
      ],
      explanation:
        "Образующая: l=√(5²+3²)=√34. Сечение — равнобедренный треугольник SAB с боковыми сторонами SA=SB=l и прямым углом при вершине S. Проверка существования: хорда AB=l√2=√68=2√17≈8,25, что меньше диаметра основания 2r=10 — сечение возможно. Площадь прямоугольного треугольника с катетами SA и SB: S=(1/2)·SA·SB=(1/2)·(√34)²=(1/2)·34=17.",
      difficulty: 3,
      egeTaskNumber: 14,
    },
    {
      id: stableId("p"),
      skillId: skRevolutionSections,
      text: "Радиус основания цилиндра равен 3, высота равна 4. Точки A и B — концы диаметра нижнего основания. Точка C лежит на окружности верхнего основания так, что радиус O₁C перпендикулярен диаметру AB (O₁ — центр верхнего основания). Найдите расстояние между прямыми AB и O₁C.",
      answerType: "DETAILED",
      correctAnswer: "4",
      diagram: {
        kind: "cylinder",
        points: [
          { angle: 0, label: "A", base: "bottom" },
          { angle: 180, label: "B", base: "bottom" },
          { angle: 90, label: "C", base: "top" },
        ],
        segments: [
          ["A", "B"],
          ["O1", "C"],
      ...
      keyFormula: "d=|(O₁−A)·[u,v]| / |[u,v]|",
      hints: [
        "Введите координаты: центр нижнего основания O — начало координат, ось Oz — ось цилиндра. Тогда A=(r,0,0), B=(−r,0,0), O₁=(0,0,h), C=(0,r,h).",
        "Направляющий вектор AB — (1,0,0), направляющий вектор O₁C — (0,1,0). Их векторное произведение — (0,0,1). Расстояние — это проекция вектора между произвольными точками прямых на это векторное произведение.",
      ],
      explanation:
        "Координаты: O=(0,0,0), O₁=(0,0,4), A=(3,0,0), B=(−3,0,0), C=(0,3,4) (так как O₁C⊥AB и |O₁C|=r=3). Направляющие векторы: u=AB=(1,0,0), v=O₁C=(0,1,0). Векторное произведение u×v=(0,0,1), |u×v|=1. Вектор между точками прямых: O₁−A=(0,0,4)−(3,0,0)=(−3,0,4). Расстояние d=|(−3,0,4)·(0,0,1)|/1=|4|=4. (Результат не зависит от радиуса — расстояние между двумя взаимно перпендикулярными диаметрами оснований цилиндра всегда равно его высоте.)",
      difficulty: 3,
      egeTaskNumber: 14,
    }
  );
