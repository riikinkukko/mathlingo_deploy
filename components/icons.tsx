...
export function IconLock({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <rect x="5" y="11" width="14" height="9" rx="2.5" stroke="currentColor" strokeWidth="2" />
      <path
...
export function IconFlame({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M12 2c1 3-3 4-3 8a3 3 0 106 0c0-1-1-2-1-3 2 1 4 4 4 7a6 6 0 11-12 0c0-5 3-8 6-12z" />
    </svg>
  );
}
...
export function IconMap({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <path
        d="M9 5L3 7v13l6-2m0-13l6 2m-6-2v13m6-11l6-2v13l-6 2m0-13v13"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function IconTriangleShape({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <path
...
export function IconCircleShape({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
...
export function IconTrapezoidShape({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <path
        d="M6 17L9 6h6l3 11H6z"
        stroke="currentColor"
        strokeWidth="2.2"
        strokeLinejoin="round"
      />
...
export function IconRectangleShape({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <rect x="4" y="7" width="16" height="10" rx="1" stroke="currentColor" strokeWidth="2.2" />
    </svg>
  );
}

export function IconParallelogramShape({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <path
        d="M7 17L9 6h11l-2 11H7z"
        stroke="currentColor"
        strokeWidth="2.2"
        strokeLinejoin="round"
      />
...
export function IconBattery({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <rect x="2" y="7" width="17" height="10" rx="2" stroke="currentColor" strokeWidth="2" />
      <path d="M21 10v4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      <path d="M6 10v4M10 10v4M14 10v4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M4 15.5A2.5 2.5 0 006.5 18H20" stroke="currentColor" strokeWidth="2" />
    </svg>
  );
}
